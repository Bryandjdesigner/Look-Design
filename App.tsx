...
const App: React.FC = () => {
  ...
  const handleGarmentSelect = useCallback(async (garmentFile: File, garmentInfo: WardrobeItem) => {
    ...
    try {
      // Ensure displayImageUrl is cast to string as its non-nullity is checked above.
  ...
  const handlePoseSelect = useCallback(async (newIndex: number) => {
    ...
    setError(null);
    setIsLoading(true);
    setLoadingMessage(`Alterando pose...`);
    const prevPoseIndex = currentPoseIndex;
    setCurrentPoseIndex(newIndex);
    try {
      // Cast baseImageForPoseChange to string as its non-nullity is checked above.
      ...
      setError(getFriendlyErrorMessage(err, 'Falha ao alterar pose'));
