          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              <h1 className="text-5xl md:text-6xl font-serif font-bold text-gray-900 leading-tight">
                ...
                <span className="block mt-2 text-xl md:text-2xl font-sans font-medium text-gray-500">
                  Crie seu modelo para qualquer visual.
                </span>
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Já imaginou como uma roupa ficaria em você? Pare de adivinhar. Carregue uma foto e veja por si mesmo. Nossa IA cria seu modelo pessoal, pronto para experimentar qualquer coisa.
              </p>
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Selecione uma foto nítida e de corpo inteiro. Fotos apenas de rosto também funcionam, mas é preferível fotos de corpo inteiro para obter melhores resultados.</p>
                <p className="text-gray-500 text-xs mt-1">Ao fazer upload, você concorda em não criar conteúdo prejudicial, explícito ou ilegal. Este serviço é apenas para uso criativo e responsável.</p>
