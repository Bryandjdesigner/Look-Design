...
const REMIX_SUGGESTIONS = [
  "Sugestão: Gere um lookbook compartilhável.",
  "Sugestão: Integre uma API de e-commerce para encontrar itens similares.",
  "Sugestão: Adicione acessórios como chapéus, óculos ou bolsas.",
  "Sugestão: Crie uma 'nota de estilo' para os looks.",
  "Sugestão: Permita que os usuários salvem seus looks favoritos.",
  "Sugestão: Gere diferentes variações de cores para as roupas.",
];
