...
// Updated handler to correctly extract images from candidates following guidelines
const handleApiResponse = (response: GenerateContentResponse): string => {
    ...
    const textFeedback = response.text; // Access .text property directly
    const errorMessage = textFeedback 
        ? `The AI model did not return an image. Model responded with: "${textFeedback}"`
        : "The AI model did not return an image. This can happen due to safety filters. Please try a different image.";
